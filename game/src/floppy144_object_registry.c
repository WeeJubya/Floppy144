    ...
    floppy144_archive_terminal_interaction =
{
    ...
    "PRESS A TO ACCESS GDR TERMINAL",
    FLOPPY144_COLLECTION_HR01,
    "PRESS A TO REVIEW RESTORED COLLECTIONS",
    NULL,
    NULL,
    NULL,
    0U
    ...
    floppy144_desk_one_interaction =
{
    ...
    50U,
    FLOPPY144_COLLECTION_COUNT,
    "PRESS I TO INSPECT RECONSTRUCTED DESK",
    FLOPPY144_COLLECTION_COUNT,
    NULL,
    "DESK 01: DESK-NUMBER LABELS AND ROUTINE PAPERWORK.",
    NULL,
    NULL,
    0U
};
    ...
    floppy144_desk_four_interaction =
{
    ...
    FLOPPY144_COLLECTION_COUNT,
    NULL,
    "DESK 02: TEMPORARY DESK ALLOCATION AND HR HOT-DESKING MATERIAL.",
    NULL,
    NULL,
    0U
};
    ...
    floppy144_personnel_forms_interaction =
{
    ...
    100U,
    FLOPPY144_COLLECTION_COUNT,
    "PRESS I TO INSPECT PERSONNEL FORMS",
    FLOPPY144_COLLECTION_COUNT,
    NULL,
    ...
    floppy144_suppression_panel_interaction =
{
    ...
    100U,
    FLOPPY144_COLLECTION_COUNT,
    "PRESS I TO INSPECT SUPPRESSION PANEL",
    FLOPPY144_COLLECTION_COUNT,
    NULL,
...
floppy144_final_isolation_register_interaction =
{
    ...
    100U,
    FLOPPY144_COLLECTION_COUNT,
    "PRESS I TO INSPECT FINAL ISOLATION REGISTER",
    FLOPPY144_COLLECTION_COUNT,
    NULL,
...
floppy144_site_closure_handover_interaction =
{
    ...
    100U,
    FLOPPY144_COLLECTION_COUNT,
    "PRESS I TO INSPECT SITE CLOSURE HANDOVER FOLDER",
    FLOPPY144_COLLECTION_COUNT,
    NULL,
